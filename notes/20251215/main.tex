...
\section{行列を用いた条件\ref{condition:a},\ref{condition:b}を満たす解空間の特定}\label{sec:8}
...
ここで、$\cy{[c_1, c_2]}{[r_1, r_2]}{X}$が閉ならば、$\cy{[c_1, c_2]}{[r_2, r_1]}{X},\cy{[c_2, c_1]}{[r_1, r_2]}{X},\cy{[c_2, c_1]}{[r_2, r_1]}{X}$も閉である。
