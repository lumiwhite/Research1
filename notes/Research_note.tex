...
\end{align}
この式を複数のサイクルに関して考えた結果、$V'_{\mathcal{C}_1},V'_{\mathcal{C}_2},\dots$が生成されたとする。
これを用いて、
\begin{align}
  M = \begin{bmatrix}
    V'_{\mathcal{C}_1}\\
  ...
  \end{bmatrix}
\end{align}
とすると、条件\ref{condition:c}を満たすための必要条件は
\begin{align}
  M\cU \equiv \dU\pmod{P}
\end{align}
において、$\dU$の要素がすべて非ゼロであることである。
